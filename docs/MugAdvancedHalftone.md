...
`MugAdvancedHalftone.fuse` は、DaVinci Resolve/Fusion 向けの高品質なリアルタイム・ハーフトーン生成プラグイン (v1.91) です。
...
- **カラー表現と版ズレ (RGB Shift)**: ユーザー定義色や入力画像の直接合成に加え、RGBチャンネルを物理的にズラしてサンプリングし、見当ズレ・色収差をシミュレート。
...
---
*Generated based on source code MugAdvancedHalftone.fuse v1.91*
